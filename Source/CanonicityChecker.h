...
public:
	...
	CK inline size_t findSolutionIndex(const S *pFirst, size_t idx, S *pMem, size_t *pCanonIdx, int &nCanon)
	...
	CC inline S *improvedSolution() const			{ return m_pImprovedSol; }
