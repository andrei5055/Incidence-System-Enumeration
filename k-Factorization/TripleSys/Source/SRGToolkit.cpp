...
SRGToolkit::SRGToolkit(int nCols, int nRows, int groupSize) : 
	...
	m_pNumOrbits = new unsigned short[2 * m_v];
...
void SRGToolkit::printAdjMatrix(ctchar* pGraph, tchar* pGraphOut, int idx, int startVertex) {
	for (int i = startVertex; i < m_v; i++) {
