...
class K16A2Old : public KBase<Mask256_C> {
public:
    ...
    K16A2Old(const FactorParams& factParam, int fixed3RowsIndex, int kThreads, const unsigned char* first3Rows, ResultCallback callback, void* cbClassPtr = NULL, bool bPrint = true);
    ~K16A2Old() {}
