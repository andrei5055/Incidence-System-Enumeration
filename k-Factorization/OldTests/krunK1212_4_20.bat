...
k-Sys.exe kparamK1212_4_20.txt

:: Check if solver failed
if %ERRORLEVEL% NEQ 0 (
    echo [ERROR] Solver failed with code %ERRORLEVEL%.
    pause
    exit /b %ERRORLEVEL%
)

SET "WINMERGE=C:\Users\%username%\AppData\Local\Programs\WinMerge\WinMergeU.exe"
SET "FILE1=.\ExpectedResults\2-Partite_graphs\12\24x12x2_420\UC0000000001.txt"
SET "FILE2=..\LOGS_CK\2-Partite_graphs\12\24x12x2_420\UC0000000001.txt"
